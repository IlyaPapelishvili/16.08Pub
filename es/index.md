...
La forma más sencilla de medir todos los Core Web Vitals es utilizar la [biblioteca de JavaScript web-vitals](https://github.com/GoogleChrome/web-vitals) , una pequeña envoltura lista para la producción de las API web subyacentes que mide cada métrica de una manera que coincide con la forma en que son informadas por todos los Herramientas de Google enumeradas anteriormente.
